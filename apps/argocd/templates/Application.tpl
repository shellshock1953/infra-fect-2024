...
metadata:
  ...
  namespace: argocd
  annotations:
    notifications.argoproj.io/subscribe.on-sync-succeeded.telegram: {{ .Values.notification.channel | quote }}
    notifications.argoproj.io/subscribe.on-sync-failed.telegram: {{ .Values.notification.channel | quote }}
    notifications.argoproj.io/subscribe.on-health-degraded.telegram: {{ .Values.notification.channel | quote }}
spec:
  destination:
